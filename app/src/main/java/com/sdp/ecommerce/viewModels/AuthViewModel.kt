package com.sdp.ecommerce.viewModels
...
import com.sdp.ecommerce.data.utils.LogInErrors
import com.sdp.ecommerce.data.utils.SignUpErrors
import com.sdp.ecommerce.data.utils.UserType
import com.sdp.ecommerce.ui.LoginViewErrors
import com.sdp.ecommerce.ui.SignUpViewErrors
...
class AuthViewModel(application: Application) : AndroidViewModel(application) {
	...
	private val authRepository = (ShoppingApplication(application)).authRepository
	private val productsRepository = (ShoppingApplication(application)).productsRepository
	...
	private fun checkUniqueUser(uData: UserData) {
		viewModelScope.launch {
			val res = async { authRepository.checkEmailAndMobile(uData.email, uData.mobile, getApplication()) }
